...
import { p as parseURL, e as encodePath, l as decodePath, m as hasProtocol, n as isScriptProtocol, o as joinURL, w as withQuery, q as sanitizeStatusCode, r as getContext, $ as $fetch, v as defu, f as createError$1, x as executeAsync } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "chronicle",
    path: "/chronicle",
    component: () => import('./index-BMwdG3c0.mjs')
  },
  {
    name: "linter",
    path: "/linter",
    component: () => import('./index-BMLyehQf.mjs')
  },
  {
    name: "lore",
    path: "/lore",
    component: () => import('./index-Bn3M3eUV.mjs')
  },
  {
    name: "nexus",
    path: "/nexus",
    component: () => import('./index-BovjtXUV.mjs')
  },
  {
    name: "settings",
    path: "/settings",
    component: () => import('./settings-B8EyaSQV.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-rMx7oj5y.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BYylNG1D.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CDA5Y9cB.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CHOjPv9r.mjs'));
